...
More details about the whole intent flow can be found in the [Orchestrator documentation](https://github.com/ithacaxyz/porto/blob/main/apps/docs/pages/contracts/orchestrator.md).
