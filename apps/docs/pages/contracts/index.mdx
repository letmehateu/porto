...
<img className="dark:hidden" src="../../public/architecture-light.png" alt="Architecture" />
<img className="hidden dark:block" src="../../public/architecture.png" alt="Architecture" />
