...
```sh
cast rpc --rpc-url https://rpc.porto.sh wallet_verifySignature '[{"address": "0x1234567890123456789012345678901234567890", "chainId": 8453, "digest": "0xabcd", "signature": "0x1234"}]'
```
